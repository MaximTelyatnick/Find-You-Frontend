...
const Sidebar = () => {
   ...
   useEffect(() => {
      ...
      // Подписка на событие обновления пользователя
   ...
   // Обновление данных при изменении состояния isOpenLogin
   useEffect(() => {
      const currentUser = loadUserData();
      if (currentUser) {
         getIsFav(currentUser.id);
   ...
   // Обновление пользователя при изменении userCheck
   useEffect(() => {
      loadUserData();
   }, [userCheck]);
               ...
               <div className="sidebar-user__profile">
                  ...
                  <div className="sidebar-user__avatar">
                     <div className="sidebar-user__photo">
                        {user.avatar ? <img src={transformPhotoAvatar(user.avatar)} /> : <svg width="35" height="35" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
